...
setwd("D:/Lectures/(2020-2021) Lectures Junior/IE360/Project/Project")
library(lubridate)
library(readxl)
library(zoo)
library(data.table)
...
Click [here](https://bu-ie-360.github.io/fall20-burucusturancan/files/Group8Report.Rmd) to reach the RMD file.